            ...
            <div class="box-container">
               ...
               ?>
                  <div class="box">
                     ...
                     <p> Reason: <span><?php echo $fetch_message['message']; ?></span> </p>
                     <a href="admin_contacts.php?delete=<?php echo $fetch_message['id']; ?>"
                        onclick="return confirm('Delete this message?');" class="delete-btn">Remove Application</a>
                  </div>
                  <?php
                  };
               }else{
                  echo '<p class="empty">There are no messages yet !</p>';
               }
               ?>
            </div>
         </section>
